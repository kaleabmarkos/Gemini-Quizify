...
class EmbeddingClient:
    ...
    for model name, project, and location. Your task is to implement the __init__(model_name=model_name, project=project, loaction=location) method based on the provided
    ...
    def __init__(self, model_name, project, location):
        ...
        # the VertexAIEmbeddings wrapper from Langchain here
